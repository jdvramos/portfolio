...
import TalkingDreamsBanner from "/talking-dreams-banner.png";
import PlantaBanner from "/planta-banner.png";
import PorfolioBanner from "/portfolio-banner.png";
            ...
            <div className="projects-container">
                <div className="project-item highlighted-project">
                    ...
                    <p className="project-details">
                        Talking Dreams is an interactive chat platform that
                        enables seamless communication with your friends,
                        allowing you to exchange messages in real-time.
                    </p>
                    <span className="feature-title">Main Features:</span>
                    <ul className="app-features">
                        <li>
                            Real-time communication and instant notifications
                            using Socket.IO.
                        </li>
                        ...
                        <li>
                            Indication when a friend is currently typing a
                            message.
                        </li>
                        <li>
                            Fully responsive design for optimal usage across
                            devices.
                        </li>
                        <li>
                            Secure authentication with JWT refresh and access
                            tokens.
                        </li>
                    </ul>
                ...
                <div className="project-item">
                    ...
                    <p className="project-details">
                        Clone of Planta website. Made using HTML, CSS, and
                        JavaScript.
                    </p>
                    <div className="button-group">
                        <a
